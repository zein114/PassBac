            ...
            <div className="flex-1 flex flex-col justify-center px-4 sm:px-8 md:px-12 py-12 relative z-10">
                <div className="w-full max-w-md mx-auto relative pt-12 lg:pt-0">
                    ...
                    <div className="text-center lg:text-left mb-8">
                        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">{t('login')}</h2>
                        <p className="mt-2 text-gray-500 text-sm sm:text-base">{t('loginPrompt')}</p>
                    </div>
